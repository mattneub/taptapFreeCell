...
struct GameViewInterfaceConstructor : GameViewInterfaceConstructorType {
    func constructInterface(in view: UIView) -> [[CardView]] {
        ...
        // freecells
        let freecell1 = CardView(category: .freeCell, index: 0).applying {
            view.addSubview($0)
            $0.widthConstraint.constant = CardView.baseSize.width
            $0.widthConstraint.isActive = true
            $0.heightConstraint.constant = CardView.baseSize.height
        ...
        let freecell2 = CardView(category: .freeCell, index: 1).applying {
            view.addSubview($0)
            $0.widthConstraint.constant = CardView.baseSize.width
            $0.widthConstraint.isActive = true
            $0.heightConstraint.constant = CardView.baseSize.height
        ...
        let freecell3 = CardView(category: .freeCell, index: 2).applying {
            view.addSubview($0)
            $0.widthConstraint.constant = CardView.baseSize.width
            $0.widthConstraint.isActive = true
            $0.heightConstraint.constant = CardView.baseSize.height
        ...
        let freecell4 = CardView(category: .freeCell, index: 3).applying {
            view.addSubview($0)
            $0.widthConstraint.constant = CardView.baseSize.width
            $0.widthConstraint.isActive = true
            $0.heightConstraint.constant = CardView.baseSize.height
        ...
        for index in 0..<8 {
            let column = CardView(category: .column, index: index).applying {
                view.addSubview($0)
                $0.widthConstraint.constant = CardView.baseSize.width
                $0.widthConstraint.isActive = true
                $0.heightConstraint.constant = CardView.baseSize.height
